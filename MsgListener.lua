...
local onSendInspectInfo = function(params, player)
  ...
  SS_Target_TMPData = {
    ...
    skills = {
      ...
      meleeModified = modifierDirection(melee),
      range = SS_Shared_NumFromStr(range),
      rangeModified = modifierDirection(range),
      magic = SS_Shared_NumFromStr(magic),
      magicModified = modifierDirection(magic),
      religion = SS_Shared_NumFromStr(religion),
      religionModified = modifierDirection(religion),
      perfomance = SS_Shared_NumFromStr(perfomance),
      perfomanceModified = modifierDirection(perfomance),
      missing = SS_Shared_NumFromStr(missing),
      missingModified = modifierDirection(missing),
      hands = SS_Shared_NumFromStr(hands),
      handsModified = modifierDirection(hands),
      athletics = SS_Shared_NumFromStr(athletics),
      athleticsModified = modifierDirection(athletics),
      observation = SS_Shared_NumFromStr(observation),
      observationModified = modifierDirection(observation),
      knowledge = SS_Shared_NumFromStr(knowledge),
      knowledgeModified = modifierDirection(knowledge),
      controll = SS_Shared_NumFromStr(controll),
      controllModified = modifierDirection(controll),
      judgment = SS_Shared_NumFromStr(judgment),
      judgmentModified = modifierDirection(judgment),
      acrobats = SS_Shared_NumFromStr(acrobats),
      acrobatsModified = modifierDirection(acrobats),
      stealth = SS_Shared_NumFromStr(stealth),
      stealthModified = modifierDirection(stealth),
    },
  }
